        ...
        <nav className="border-gray-200 bg-green-500">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <div className="flex items-center  rounded-xl">
                    <img src="tridigit.jpeg" className="h-8 mr-3" alt="Tridigit Logo" />
                    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white-500">TriDigit</span>
                </div>
                ...
                <div className="hidden w-full md:block md:w-auto" id="navbar-default">
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 dark:bg-gray-800 md:bg-green-500 ">
                        <li>
                            <a href="#" className="block py-2 pl-4 pr-4 text-green-500 bg-white rounded md:bg-white md:text-red-700 md:p-0 dark:text-white md:dark:text-green-500" aria-current="page">Home</a>
                        </li>
                        <li>
